...
> **Status: v0.1.0, phases 0 and 1 shipped of 8.** Today potsherd rescues,
> indexes and searches. Cards, `ask` and `graft` land in the phases that follow
...
| 1 | full parser, sidechains, codex/cursor/pi adapters, redaction, `index`, `find`, `ls`, `show`, `stats` | **shipped** |
| 2 | verified per-session cards, tags, pins, links | next |
