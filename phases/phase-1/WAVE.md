...
| integration | T1.5a index (fts5, vec, redaction wired) | worker | `task/T1.5a-index` | **done** | 351 tests. 30+197 claude · 1 codex · 4 cursor · 4 pi · 299 ghosts. full 5m22s, no-embed 10.9s, incremental 27ms |
